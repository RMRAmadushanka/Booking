...
// Exact pixel size so all social icons render identically on desktop and mobile
const SOCIAL_ICON_PX = 20;

// Wrapper that forces every social icon into the same 20x20px box (inline styles so nothing overrides)
const SocialIconBox: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <span
    style={{ width: SOCIAL_ICON_PX, height: SOCIAL_ICON_PX, display: "inline-flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}
    aria-hidden
  >
    {children}
  </span>
...
// Social media icons – fixed width/height so Facebook, Instagram, LinkedIn, X are the same size
const FacebookIcon = () => (
  <svg width={30} height={30} viewBox="0 0 22 22" fill="currentColor" style={{ display: "block" }} aria-hidden="true">
    <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
  </svg>
);

const InstagramIcon = () => (
  <svg width={SOCIAL_ICON_PX} height={SOCIAL_ICON_PX} viewBox="0 0 24 24" fill="currentColor" style={{ display: "block" }} aria-hidden="true">
...
const LinkedInIcon = () => (
  <svg width={18} height={18} viewBox="0 0 23 23" fill="currentColor" style={{ display: "block" }} aria-hidden="true">
    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
  </svg>
);

const XIcon = () => (
  <svg width={SOCIAL_ICON_PX} height={SOCIAL_ICON_PX} viewBox="0 0 23 23" fill="currentColor" style={{ display: "block" }} aria-hidden="true">
                    ...
                    return (
                      <li key={link.label}>
                        <a
                          ...
                          className="flex items-center justify-center size-10 min-w-10 min-h-10 rounded-full text-[#64748B] hover:text-[#2563EB] hover:bg-[#2563EB]/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB] focus-visible:ring-offset-2 transition-colors duration-200"
                        >
                          <SocialIconBox>
                            <IconComponent />
                          </SocialIconBox>
          ...
          <div>
            ...
            <address className="not-italic space-y-3 text-sm">
              <div className="flex items-start gap-3">
                <PhoneIcon className="w-5 h-5 text-[#2563EB] flex-shrink-0 mt-0.5" aria-hidden />
                <div>
                  <a
                    href="tel:+94112345678"
                    className="text-[#2563EB] hover:text-[#1D4ED8] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB] focus-visible:ring-offset-2 transition-colors duration-200"
                  >
                    +94 11 234 5678
                  </a>
                </div>
              ...
              <div className="flex items-start gap-3">
                <EnvelopeIcon className="w-5 h-5 text-[#2563EB] flex-shrink-0 mt-0.5" aria-hidden />
                <div>
                  <a
              ...
              <div className="flex items-start gap-3">
                <MapPinIcon className="w-5 h-5 text-[#2563EB] flex-shrink-0 mt-0.5" aria-hidden />
                <span className="text-[#64748B]">Sri Lanka</span>
              </div>
              <div className="flex items-start gap-3">
                <ClockIcon className="w-5 h-5 text-[#2563EB] flex-shrink-0 mt-0.5" aria-hidden />
          ...
          <div className="pt-4 border-t border-[#64748B]/20">
            ...
            <address className="not-italic space-y-3 text-sm">
              <div className="flex items-center gap-3 min-h-[44px]">
                <PhoneIcon className="w-5 h-5 text-[#2563EB] flex-shrink-0" aria-hidden />
                <a
                  href="tel:+94112345678"
                  className="text-[#2563EB] hover:text-[#1D4ED8] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB] focus-visible:ring-offset-2 transition-colors duration-200"
                >
              ...
              <div className="flex items-center gap-3 min-h-[44px]">
                <EnvelopeIcon className="w-5 h-5 text-[#2563EB] flex-shrink-0" aria-hidden />
                <a
                  href="mailto:info@Drimooria Travels.com"
                  className="text-[#2563EB] hover:text-[#1D4ED8] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB] focus-visible:ring-offset-2 transition-colors duration-200"
                >
              ...
              <div className="flex items-center gap-3 min-h-[44px]">
                <MapPinIcon className="w-5 h-5 text-[#2563EB] flex-shrink-0" aria-hidden />
                <span className="text-[#64748B]">Sri Lanka</span>
              </div>
              <div className="flex items-center gap-3 min-h-[44px]">
                <ClockIcon className="w-5 h-5 text-[#2563EB] flex-shrink-0" aria-hidden />
                <span className="text-[#64748B]">Mon – Fri: 9:00 AM – 6:00 PM</span>
              </div>
            </address>
