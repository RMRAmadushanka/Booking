...
/**
 * Skeleton loader that mirrors the vehicle detail page layout.
 * Used in app/vehicles/[id]/loading.tsx.
 */
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-5 mb-6">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-[var(--radius-md)] p-4 sm:p-5 w-full lg:w-[360px] shrink-0">
            <div className="h-4 w-20 bg-slate-200 rounded" />
            <div className="h-9 w-24 bg-slate-200 rounded mt-2" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          {/* Right column - rental form skeleton */}
